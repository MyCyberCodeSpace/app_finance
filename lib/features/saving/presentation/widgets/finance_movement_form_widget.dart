...
class FinanceMovementFormWidget extends StatefulWidget {
  final FinanceSavingFormController controller;
  final GlobalKey<FormState> formKey;
  final VoidCallback onSelectDate;
  final VoidCallback onSubmit;

  const FinanceMovementFormWidget({
    super.key,
  ...
  @override
  State<FinanceMovementFormWidget> createState() =>
      _FinanceMovementFormWidgetState();
}

class _FinanceMovementFormWidgetState
    extends State<FinanceMovementFormWidget> {
  @override
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                Expanded(
                  child: OutlinedButton(
                    onPressed: () {
                      setState(
                        () => widget.controller.selectedMovementType =
                            'entrada',
                      );
                    },
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                prefixStyle: TextStyle(
                  color: widget.controller.selectedMovementType ==
                          'entrada'
                      ? AppColors.positiveBalance
                      : AppColors.nevagativeBalance,
                ...
                filled: true,
                fillColor: (widget.controller.selectedMovementType ==
                        'entrada'
                    ? AppColors.positiveBalance
                    : AppColors.nevagativeBalance)
            ...
            DatePickerFieldWidget(
              ...
              onDateSelected: () {
                // Trigger parent widget to update state if needed
                widget.onSelectDate.call();
              },
              validator: (v) =>
                  widget.controller.selectedMovementDate == null
                  ? 'Selecione uma data'
                  : null,
            ),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                hintText:
                    'Ex: Depósito mensal, Saque para emergência...',
                filled: true,
